...
import strategicIcon from "../assets/icons/strategicexpertise.svg";
        ...
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            if (entry.target === sectionRef.current) {
              ...
              const benefitItems =
                entry.target.querySelectorAll(".benefit-item");
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="wwu-header text-center mb-16">
          ...
          <p className="wwu-subtitle text-lg md:text-xl text-[#6B7280] max-w-3xl mx-auto">
            At North Vista Global, we blend strategic insight with personalized
            service to help you achieve freedom and opportunity across borders.
          </p>
        </div>
        ...
        <div
          ref={sectionRef}
          className="wwu-benefits grid grid-cols-1 md:grid-cols-2 gap-8 mb-16"
        >
        ...
        <div
          ref={ctaRef}
          className="wwu-cta-banner bg-white text-[#1E453E] p-12 rounded-xl opacity-0"
        >
          <div className="cta-content text-center max-w-3xl mx-auto">
            ...
            <p className="cta-subtitle text-lg opacity-90 mb-8">
              Connect with our experts for personalized guidance and solutions
