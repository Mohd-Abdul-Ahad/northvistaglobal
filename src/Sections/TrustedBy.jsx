  ...
  return (
    <section ref={sectionRef} className="bg-white py-24 px-6 md:px-12">
      <div className="max-w-7xl mx-auto text-center">
        {/* Section Header */}
        <h2 className="text-3xl md:text-4xl font-bold text-[#1E453E] mb-6">
          Trusted by Global Citizens Worldwide
        </h2>

        {/* Subtext */}
        <p className="text-lg md:text-xl text-gray-600 mb-16 max-w-3xl mx-auto">
          A trusted ecosystem of licensed attorneys, regulated financial
          partners, and real-estate specialists.
        </p>

        {/* Partner Logos Carousel */}
        <div className="flex items-center justify-center">
          <div className="relative overflow-hidden w-180">
            <div
              className={`flex justify-center items-center space-x-16 animate-marquee whitespace-nowrap ${
            ...
            >
              {partners.map((partner, idx) => (
                ...
                >
                  ...
                  <span className="text-lg font-medium text-[#1E453E]">
                    {partner.name}
                  </span>
                </div>
              ))}
