...
const Herobanner = () => {
  ...
  return (
    ...
    >
      ...
      c0-2.54,2.02-4.71,4.59-4.71h5.65c-1.42-0.8-2.39-2.35-2.39-4.13c0-极速赛车开奖结果2.54,2.02-4.71,4.59-4.71l37.3,0
                    ...
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-full flex items-center justify-center p-1 sm:p-2 shadow-lg transform transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl mb-1">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M2.79,41.59L61.44,0l58.95,41.59H2.79z M0,102.28h9.08v-6.33h1.32v-3.02l3.85,0V56极速赛车开奖结果.7H6.38v-8.68h110.11v8.68h-7.86v36.23h3.85v3.02l1.32,0v6.33h9.08v6.63H0V102.28z M32.59,95.95h4.44v-3.02l3.85,0V56.7H28.74v36.23h3.85V95.95z M59.22,95.95h4.45v-3.02l3.84,0V56.7H55.37v36.23h3.85V95.95z M85.85,95.95h4.45v-3.02l3.85,0V56.7H82v36.23h极速赛车开奖结果3.85V95.95z M41.69,31.1l19.84-15.22L81.48,31.1H41.69z"
                        />
                      </svg>
                    </div>
                    <span className="text-white text-xs font-medium group-hover:text-[#a8d5ba] transition-colors duration-300 text-center leading-tight">
