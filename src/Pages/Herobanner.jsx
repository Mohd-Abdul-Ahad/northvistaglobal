...
import HeroBannerImg from "../assets/Images/herobannerr.webp"; // keep this for Vite image handling
...
const Herobanner = () => {
  ...
  return (
    <div
      className="relative w-full h-screen min-h-[800px] bg-cover bg-center bg-no-repeat"
      style={{
      ...
      <div className="relative z-10 h-full flex items-center pt-20">
        <div className="container mx-auto px-4 sm:px-8 lg:px-12 xl:px-16">
          <div className="max-w-3xl space-y-6 text-left text-white">
            <h1 className="serif text-4xl sm:text-5xl md:text-6xl font-bold leading-tight animate-fade-in-left delay-100">
              Your Gateway to Global Residency & Citizenship
            </h1>

            <p className="sans text-lg md:text-xl leading-relaxed animate-fade-in-left delay-300">
