    ...
    <>
      ...
      <div className="relative w-full py-20 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="container mx-auto px-6 lg:px-12 xl:px-24 max-w-4xl">
              ...
              <form className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="relative">
                    ...
                    >
                      <option value="">
                        Select your primary goal (Residence Programs)
                      </option>
                      <option value="">
                        EB-5 Investor Visa (USA) (Residence Programs)
                      </option>
                      <option value="">
                        New Brunswick PNP Entrepreneur Streams (Residence
                        Programs)
                      </option>
                      <option value="">
                        Europe – Golden Visas (Portugal, Greece, Malta)
                        (Residence Programs)
                      </option>
                      <option value="">
                        Caribbean Citizenship by Investment (Residence Programs)
                      </option>
                      <option value="">
                        UAE Golden Visa (Residence Programs)
                      </option>
                      <option value="">EB-5 Investor Visa (Citizenship)</option>
                      <option value="">
                        Newbrunswick PNP Entrepreneur Streams (Citizenship)
                      </option>
                      <option value="">
                        Europe – Golden Visas (Portugal, Greece, Malta)
                        (Citizenship)
                      ...
                      <option value="">
                        Caribbean Citizenship by Investment (Citizenship)
                      </option>
                      <option value="">Portugal(Digital Nomad)</option>
                      <option value="">Estonia (Digital Nomad)</option>
                      <option value="">Panama (Digital Nomad)</option>
                      <option value="">Colombia (Digital Nomad)</option>
                      <option value="">Thailand (Digital Nomad)</option>
                      <option value="">Indonesia (Digital Nomad)</option>
                      <option value="">Panama Pensionado(Retirement)</option>
                      <option value="">
                        Mauritius Retirement (Retirement)
                      </option>
                      <option value="">Thailand Retirement (Retirement)</option>
                      <option value="">
                        Structuring investments (Business)
                      </option>
                      <option value="">Executive Relocation (Business)</option>
                      <option value="">
                        Cross-Border Expansion (Business)
                      </option>
                      <option value="">Education (Legacy Planning)</option>
                      <option value="">Healthcare (Legacy Planning)</option>
                      <option value="">
                        Wealth Diversification (Legacy Planning)
                      </option>
                      <option value="">
                        Succession Planning (Legacy Planning)
                      </option>
                    </select>
          ...
          <p className="text-black inter text-sm mt-5">
            NVG will never ask you to transfer funds to personal accounts or pay
            fees via unverified channels. Report suspicious requests to
